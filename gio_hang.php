...
$data = gio_hang::getAllgio_hang($pdo);
if (!$data) {
  ...
  <div class="text-center">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="row">
          <div class="col-md-1">
            <a href="gio_hang.php?action=empty" class="btn btn-danger mt-2">Xóa giỏ hàng</a>
          </div>

          <div class="col-md-4 offset-md-7">
            <a href="gio_hang.php?action=thanhtoan" class="btn btn-danger mt-2">Thanh toán</a>
          </div>
        </div>
      </div>
          ...
          <?php foreach ($data as $product) : ?>
            <form method="get">
              <tr>
                ...
                <td>
                  <input type="number" value="<?= $product->gio_hang_soluong ?>" name="qty" min="1" style="width: 50px;" />
                </td>
                <td>
